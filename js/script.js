...
//         strength = Math.min(strength, 3) - 1; // Adjust to 0-2 range

//         strengthMeter.style.width = ((strength + 1) / 3) * 100 + '%';
//         strengthMeter.style.backgroundColor = strengthColor[strength];
